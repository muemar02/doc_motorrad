...
F\"ur beliebige Variationen des Ortes $h\of{t}=\delta \transp{\vect{q}\of{t}}$ soll  \eqnref{gl:mech_lagrange2ArtDefAllg} erf\"ullt sein und damit ist $g\of{t}$ gleich der Nullfunktion. Die $m$ Langrange-Multiplikatoren $\lambda$ sind also so zu w\"ahlen, dass 
 \begin{align*}
...
\end{align}
  ...
  Die gesamte virtuelle Arbeit eines Systems kann auch als Summe der generalisierten Kr\"afte des Systems interpretiert werden. \eqnref{gl:virtWgenF} zeigt diesen Zusammenhang. Mit Hilfe der generalisierten Koordinaten $\vect{q}$ l\"asst sich \eqnref{gl:virtWgenF} derart umformen, dass man den zur L\"osung von \eqref{gl:mech_lagrange2ArtDefAllg} ben\"otigten Ausdruck f\"ur $Q_{ex}$ erh\"alt. 
