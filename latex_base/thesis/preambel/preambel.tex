...
\newcommand*{\maketitleITVS}{%
\deftiteltrue
\begin{titlepage}
\begin{center}
    {\usekomafont{title}\LARGE Technische Universität Dresden}\\[2ex]
    {\usekomafont{title}\large Fakultät Verkehrswissenschaften \glqq Friedrich List\grqq { }}\\[2ex]
    {\usekomafont{title}\large Institut für Verkehrstelematik}\\[2ex]
    {\usekomafont{title}\large Professur für Informationstechnik f\"ur Verkehrssysteme}\\
    \vfill
    ...
    \begin{tabular}{ll}
        \ifx\@betreuer\empty\else Betreuer: \@betreuer\fi
        Verantwortlicher Hochschullehrer: & Prof. Dr.-Ing. Oliver Michler\\
        Tag der Einreichung: & \@date
    \end{tabular}
\end{center}
\end{titlepage}
